  ...
  render() {
    ...
    return (
      ...
      <nav className="sb-topnav navbar navbar-expand navbar-dark bg-dark">
        <a className="navbar-brand" href="index.html">VD</a>
        ...
        <div id="layoutSidenav_content">
          <main>
            <div className="container-fluid">  
              <div className="card mb-4" style={{marginTop: "0"}} >
                <div className="card-header">
                  <i className="fas fa-table mr-1" />
                  DataTable 
                </div>
                <Form inline style={{marginTop:"10px"}}>
                    <FormGroup className="mb-4 mr-sm-4 mb-sm-4">
                      <Label for="exampleEmail" className="mr-sm-4">Email</Label>
                      <Input type="email" name="email" className="mr-sm-4" id="exampleEmail" placeholder="something@idk.cool" />
                    </FormGroup>
                    <FormGroup className="mb-4 mr-sm-4 mb-sm-4">
                      <Label for="examplePassword" className="mr-sm-4">Password</Label>
                      <Input type="password" name="password" className="mr-sm-4" id="examplePassword" placeholder="don't tell!" />
                    </FormGroup>
                    <Button style={{marginTop:"-23px"}}>Search</Button>
                </Form>
